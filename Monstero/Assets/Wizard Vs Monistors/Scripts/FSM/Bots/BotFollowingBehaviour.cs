...
public class BotFollowingBehaviour : StateMachineBehaviour
{
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        if (_playerDistance <= animator.GetComponent<NavMeshAgent>().stoppingDistance)
        {
            animator.SetBool("FollowPlayer", false);
        }
        animator.GetComponent<NavMeshAgent>().SetDestination(GameManager.Instance.Player.transform.position);
    }
